...
class _$SettingsStateCopyWithImpl<$Res, $Val extends SettingsState>
  ...
  @override
  $Res call({Object? isDarkMode = null, Object? language = null}) {
    return _then(
      _value.copyWith(
            isDarkMode:
                null == isDarkMode
...
class _$SettingsStateImpl implements _SettingsState {
  const _$SettingsStateImpl({this.isDarkMode = false, this.language = "en"});
...
abstract class _SettingsState implements SettingsState {
  const factory _SettingsState({final bool isDarkMode, final String language}) =
      _$SettingsStateImpl;
